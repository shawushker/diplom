        ...
        <div class="shadow-lg rounded lg">
            ...
            <div class="p-5">
                ...
                <div class="flex flex-col xl:flex-row justify-between my-3">
                    <a href="{{ route('goods.show', $good->id) }}" class="bg-gradient-to-r from-red-600 to-pink-500 rounded-full py-2 px-4 text-gray-50 flex flex-row justify-center my-2 hover:from-pink-600 to-pink-700 text-sm">
